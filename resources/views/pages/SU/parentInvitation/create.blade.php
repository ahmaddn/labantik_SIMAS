                    ...
                    <div class="card-body p-20">
                        ...
                        <div class="tab-content" id="myTab2Content">
                            <div aria-labelledby="preview2-tab" class="tab-pane fade show active" id="preview2-tab-pane"
                                ...
                                {{-- Main Form --}}
                                <form action="{{ route('su.parentInvitations.store') }}" id="mainForm" method="POST">
                                    @csrf
                                    ...
                                    <div class="tab-content" id="myTabstep2Content">
                                        ...
                                        <div aria-labelledby="step5-tab" class="tab-pane fade show active"
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <select name="categories" id="categories"
                                                                ...
                                                                <option value="Individu"
                                                                    {{ old('categories') == 'Individu' ? 'selected' : '' }}>
                                                                    Individual
                                                                </option>
                                                                <option value="Jamak"
                                                                    {{ old('categories') == 'Jamak' ? 'selected' : '' }}>
                                                                    Umum / Jamak
                                                                </option>
                                                            </select>
                                                            <i
                                                ...
                                                {{-- INDIVIDU: Kelas --}}
                                                <div class="col-lg-6" id="kelas-container" style="display: none;">
                                                    <div class="form-group mb-4">
                                                        <label class="label fs-16">
                                                ...
                                                {{-- JAMAK: Kepada --}}
                                                <div class="col-lg-6" id="kepada-container" style="display: none;">
                                                    <div class="form-group mb-4">
                                                        <label class="label fs-16">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <input type="text" name="to" id="kepada"
                                                                class="form-control ps-5 h-55 @error('kepada') is-invalid @enderror"
                                        ...
                                        <div aria-labelledby="step6-tab" class="tab-pane fade" id="step6-tab-pane"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12" id="template-individu" style="display: none;">
                                                    <div class="form-group mb-4">
                                                        <label class="label fs-16">
                                                            Template Tujuan
                                                        </label>
                                                ...
                                                <div class="col-lg-12" id="template-jamak" style="display: none;">
                                                    <div class="form-group mb-4">
                                                        <label class="label fs-16">
                                                            Template Tujuan
                                                        </label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <textarea name="purpose" class="form-control ps-5 @error('to') is-invalid @enderror" rows="4"
                                                ...
                                                {{-- Bertemu dengan --}}
                                                <div class="col-lg-6" id="with-container" style="display: none;">
                                                    <div class="form-group mb-4">
