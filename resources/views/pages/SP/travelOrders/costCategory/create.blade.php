...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Tambah Kategori Biaya</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li aria-current="page" class="breadcrumb-item active">
                        <span class="text-secondary">Tambah</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card bg-white border border-white rounded-10 mb-4">
                    <div class="card-body p-20">
                        <h4 class="fs-18 fw-medium mb-20">Data Kategori Biaya</h4>

                        <form action="{{ route('sp.travelCostCategories.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Contoh: Hotel, BBM, Tol, Pesawat..." value="{{ old('name') }}"
                                        required>
                                    <i
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <select name="type"
                                        ...
                                        <option value="accommodation"
                                            {{ old('type') === 'accommodation' ? 'selected' : '' }}>
                                ...
                                <small class="text-muted mt-1 d-block">
                                    ...
                                    <strong>Penginapan</strong> untuk biaya hotel/menginap.
                                    <strong>Transport</strong> untuk biaya BBM, tol, pesawat, travel, dll.
                                </small>
                            </div>
