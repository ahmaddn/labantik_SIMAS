                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <textarea name="content" id="content_textarea" class="form-control ps-5 @error('content') is-invalid @enderror"
                                                                rows="4" placeholder="Gunakan template di bawah atau tulis manual..." required>{{ old('content', $correction->content) }}</textarea>
                                                            <i
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <textarea name="comparison_note" class="form-control ps-5 @error('comparison_note') is-invalid @enderror"
                                                                rows="3" placeholder="Catatan tambahan mengenai perbedaan data...">{{ old('comparison_note', $correction->comparison_note) }}</textarea>
                                                            <i
