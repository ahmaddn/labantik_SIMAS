        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 p-20 pb-0">
                ...
                <div class="dropdown select-dropdown without-border">
                    <a href="{{ route('sk.goodConducts.create') }}">
                        ...
                        <tbody>
                            @forelse($goods as $good)
                                <tr>
                                    ...
                                    <td class="text-body">
                                        {{ $good->student->student->student_number ?? '-' }}
                                    </td>
                                    <td class="text-body">
                                    ...
                                    <td class="text-body">
                                        @if ($good->issue_date)
                                            {{ \Carbon\Carbon::parse($good->issue_date)->format('d/m/Y') }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-end" style="gap: 12px;">
                                            ...
                                            <!-- Tombol Edit -->
                                            <a href="{{ route('sk.goodConducts.edit', $good->id) }}"
                                            ...
                                            <button class="bg-transparent p-0 border-0 hover-text-danger" type="button"
                                                data-bs-toggle="modal" data-bs-target="#deleteletter{{ $good->id }}">
                                                <i class="material-symbols-outlined fs-16 fw-normal text-body">
                                                    delete
                                                </i>
                                            </button>

                                            <div class="modal fade" id="deleteletter{{ $good->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center py-4">
                                                            ...
                                                            <p class="text-muted mb-0">
                                                                Data Surat Keterangan Kelakuan Baik ini akan dihapus secara
                                                                permanen dan tidak dapat dikembalikan.
                                                            </p>
                                                            <p class="text-muted mt-2 mb-0">
                                                                <strong>Nomor Surat:
                                                                    <span>{{ $good->letter_number }}</span></strong>
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer border-0 justify-content-center">
                                                            ...
                                                            <form
                                                                action="{{ route('sk.goodConducts.destroy', $good->id) }}"
