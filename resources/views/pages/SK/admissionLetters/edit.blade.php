                    ...
                    <div class="card-body p-20">
                        ...
                        <div class="tab-content" id="myTab2Content">
                            <div aria-labelledby="preview2-tab" class="tab-pane fade show active" id="preview2-tab-pane"
                                ...
                                <form action="{{ route('sk.admissionLetters.update', $admission->id) }}" method="POST" id="mainForm">
                                    @csrf
                                    @method('PUT')
                                                            ...
                                                            <select name="class_id" id="class_id"
                                                                ...
                                                                @foreach ($classes as $class)
                                                                    <option value="{{ $class->id }}"
                                                                        {{ $admission->student->class_id == $class->id ? 'selected' : '' }}>
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <select name="student_id" id="siswa" required>
                                                                ...
                                                                @if ($admission->student_id && $admission->student)
                                                                    <option value="{{ $admission->student->id }}"
                                                                        selected>
                                                                        {{ $admission->student->student->full_name }}
                                                                        @if ($admission->student->student && $admission->student->student->student_number)
                                                                            ({{ $admission->student->student->student_number }})
                                                                        @endif
                                                                    </option>
                                                                @endif
                                                            </select>
                                                    ...
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <input type="text" name="letter_number"
                                                                ...
                                                                value="{{ $admission->letter_number }}" required>
                                                            <i
